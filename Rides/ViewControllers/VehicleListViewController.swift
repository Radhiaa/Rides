...
class VehicleListViewController: UITableViewController {
    ...
    @IBAction func fetchButtonTapped(_ sender: UIButton) {
        guard let inputText = inputTextField.text, let numberOfItems = Int(inputText), numberOfItems > 0 else {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let detailsVC = storyboard.instantiateViewController(withIdentifier: "VehicleDetailsViewController") as? VehicleDetailsViewController {
